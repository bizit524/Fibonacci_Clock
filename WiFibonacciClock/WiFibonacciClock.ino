...
#define MODE_BUTTON               D6
#define BRIGHTNESS_BUTTON         D7
...
Adafruit_NeoPixel _ledStrip = Adafruit_NeoPixel(LEDS_SIZE, LED_DATA, NEO_GRB + NEO_KHZ800);
...
void setup(void) {
   // We start by connecting to a WiFi network
    ...
    MyWifiManager.autoConnect("Fib Clock");
#if DEBUG
  initSerial();
#endif
  initFS();
